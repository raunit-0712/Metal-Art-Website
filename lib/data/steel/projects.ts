...
export const steelProjects: SteelProject[] = [
  ...
  },
  {
    ...
    category: 'steel',
    subcategory: 'Architectural Metal',
    description: 'This project encompassed the structural metal fabrication and heavy cladding of passenger departure gates, retail storefront frames, and check-in counters for the Terminal 1 expansion wings.',
    overview: 'This project encompassed the structural metal fabrication and heavy cladding of passenger departure gates, retail storefront frames, and check-in counters for the Terminal 1 expansion wings.',
  ...
  {
    id: '5',
    title: 'Prestige Experience Center Lobby',
    category: 'steel',
    ...
    images: steelProjectImages['prestige-Experience-center'],
    featured: true,
